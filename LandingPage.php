...
<body>
  ...
  <div class="wrapper">
    ...
    <section class="hero">
      <h1 class="font"><span class="purple">Kemudahan</span> dan <span class="purple">kenyamanan</span> dalam membaca</h1>
      <p class="subhead">Rumah Kertas adalah sebuah situs web perpustakaan yang menyediakan layanan peminjaman buku secara online.
        Situs ini menyediakan berbagai macam buku dari berbagai kategori seperti fiksi, non-fiksi, sains, sejarah,
        biografi, dan masih banyak lagi.</p>
    ...
    <div class="data">
      ...
      <p class="desc">Menyediakan berbagai akses buku digital dengan rating terbaik</p>
    </div>
